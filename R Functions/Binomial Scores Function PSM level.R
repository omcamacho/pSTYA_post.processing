...
# Generic Binomial adjustment function , returning adjusted results at PSM level #

# There are variations of this function to account for differences in variables names in different data sets#
#############################################################################################################


binAdjustPSM <- function(dataf){
  PTMscore <- dataf
