...
# Figure 4. Plotting FLR vs Ordered scores #
############################################
...
Not_adj_Ara_PSM <- cbind.data.frame(BinAdj_Ara_PSM$Peptide_mod.x,BinAdj_Ara_PSM$Peptide,BinAdj_Ara_PSM$PTM_positions,BinAdj_Ara_PSM$PTM_final_prob)
names(Not_adj_Ara_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Unadjusted_Score")

Bin_adj_Ara_PSM <- cbind.data.frame(BinAdj_Ara_PSM$Peptide_mod.x,BinAdj_Ara_PSM$Peptide,BinAdj_Ara_PSM$PTM_positions,BinAdj_Ara_PSM$NewScore3)
names(Bin_adj_Ara_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Bin_Adjusted_Score")

Prod_adj_Ara_PSM <- cbind.data.frame(ProdAdj_Ara_PSM$Peptide_mod.x,ProdAdj_Ara_PSM$Peptide,ProdAdj_Ara_PSM$PTM_positions,ProdAdj_Ara_PSM$Prod_Adjusted_Score)
...
Not_adj_Hum_PSM <- cbind.data.frame(BinAdj_Hum_PSM$Peptide_mod.x,BinAdj_Hum_PSM$Peptide,BinAdj_Hum_PSM$PTM_positions,BinAdj_Hum_PSM$PTM_final_prob)
names(Not_adj_Hum_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Unadjusted_Score")

Bin_adj_Hum_PSM <- cbind.data.frame(BinAdj_Hum_PSM$Peptide_mod.x,BinAdj_Hum_PSM$Peptide,BinAdj_Hum_PSM$PTM_positions,BinAdj_Hum_PSM$NewScore3)
names(Bin_adj_Hum_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Bin_Adjusted_Score")

Prod_adj_Hum_PSM <- cbind.data.frame(ProdAdj_Hum_PSM$Peptide_mod.x,ProdAdj_Hum_PSM$Peptide,ProdAdj_Hum_PSM$PTM_positions,ProdAdj_Hum_PSM$Prod_Adjusted_Score)
...
Not_adj_Syn138_PSM <- cbind.data.frame(BinAdj_Syn138_PSM$Peptide_mod.x,BinAdj_Syn138_PSM$Peptide,BinAdj_Syn138_PSM$PTM_positions,BinAdj_Syn138_PSM$PTM_final_prob)
names(Not_adj_Syn138_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Unadjusted_Score")

Bin_adj_Syn138_PSM <- cbind.data.frame(BinAdj_Syn138_PSM$Peptide_mod.x,BinAdj_Syn138_PSM$Peptide,BinAdj_Syn138_PSM$PTM_positions,BinAdj_Syn138_PSM$NewScore3)
names(Bin_adj_Syn138_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Bin_Adjusted_Score")

Prod_adj_Syn138_PSM <- cbind.data.frame(ProdAdj_Syn138_PSM$Peptide_mod.x,ProdAdj_Syn138_PSM$Peptide,ProdAdj_Syn138_PSM$PTM_positions,ProdAdj_Syn138_PSM$Prod_Adjusted_Score)
...
Not_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod.x,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$PTM_final_prob)
names(Not_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Unadjusted_Score")

Bin_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod.x,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$NewScore3)
names(Bin_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions" ,"Bin_Adjusted_Score")

Prod_adj_Syn7058_PSM <- cbind.data.frame(ProdAdj_Syn7058_PSM$Peptide_mod.x,ProdAdj_Syn7058_PSM$Peptide,ProdAdj_Syn7058_PSM$PTM_positions,ProdAdj_Syn7058_PSM$Prod_Adjusted_Score)
...
Graph.data.Ara <- data.frame(cbind(FLR_Adj_Ara_PSM$Rnumber,FLR_Not_Adj_Ara_PSM$FLR_Unadjusted,FLR_Adj_Ara_PSM$FLR_Adj_Score,FLR_Prod_Adj_Ara_PSM$FLR_Adj_Score))

colnames(Graph.data.Ara) <- c("Order_of_Scores","Unadjusted","Binomial_Adjustment", "Product_Adjustment")
...
Graph.data.Hum <- data.frame(cbind(FLR_Adj_Hum_PSM$Rnumber,FLR_Not_Adj_Hum_PSM$FLR_Unadjusted,FLR_Adj_Hum_PSM$FLR_Adj_Score, FLR_Prod_Adj_Hum_PSM$FLR_Adj_Score))

colnames(Graph.data.Hum) <- c("Order_of_Scores","Unadjusted","Binomial_Adjustment","Product_Adjustment")
...
Graph.data.Syn138 <- data.frame(cbind(FLR_Adj_Syn138_PSM$Rnumber,FLR_Not_Adj_Syn138_PSM$FLR_Unadjusted,FLR_Adj_Syn138_PSM$FLR_Adj_Score, FLR_Prod_Adj_Syn138_PSM$FLR_Adj_Score))

colnames(Graph.data.Syn138) <- c("Order_of_Scores","Unadjusted","Binomial_Adjustment","Product_Adjustment")
...
Graph.data.Syn7058 <- data.frame(cbind(FLR_Adj_Syn7058_PSM$Rnumber,FLR_Not_Adj_Syn7058_PSM$FLR_Unadjusted,FLR_Adj_Syn7058_PSM$FLR_Adj_Score, FLR_Prod_Adj_Syn7058_PSM$FLR_Adj_Score))

colnames(Graph.data.Syn7058) <- c("Order_of_Scores","Unadjusted","Binomial_Adjustment","Product_Adjustment")
