...
# First we calculate all binomial adjustmented data #
#####################################################
...
PXD000923_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD000923, max)
PXD002222_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD002222, max)
PXD002756_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD002756, max)
PXD004705_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD004705, max)
PXD004939_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD004939, max)
PXD005241_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD005241, max)
PXD012764_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD012764, max)
PXD019291_Max <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD019291, max)
...
FLR_AllRice_pform_Max_R10 <- FLR_AllRice_pform_Max[FLR_AllRice_pform_Max$FLR_Unadjusted<=0.1,]
FLR_AllRice_pform_Max_R5 <- FLR_AllRice_pform_Max[FLR_AllRice_pform_Max$FLR_Unadjusted<=0.05,]
FLR_AllRice_pform_Max_R1 <- FLR_AllRice_pform_Max[FLR_AllRice_pform_Max$FLR_Unadjusted<=0.01,]


Table_FLR_AllRice_pform_Max_R10 <- FLR_AllRice_pform_Max_R10 %>%
...
PXD000923_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD000923_USI3, max)
PXD002222_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD002222_USI3, max)
PXD002756_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD002756_USI3, max)
PXD004705_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD004705_USI3, max)
PXD004939_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD004939_USI3, max)
PXD005241_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD005241_USI3, max)
PXD012764_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD012764_USI3, max)
PXD019291_MM <- aggregate(Unadjusted_Score ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = PXD019291_USI3, max)
...
FLR_AllRice_pform_MM_R10 <- FLR_AllRice_pform_MM[FLR_AllRice_pform_MM$FLR_Unadjusted<=0.1,]
FLR_AllRice_pform_MM_R5 <- FLR_AllRice_pform_MM[FLR_AllRice_pform_MM$FLR_Unadjusted<=0.05,]
FLR_AllRice_pform_MM_R1 <- FLR_AllRice_pform_MM[FLR_AllRice_pform_MM$FLR_Unadjusted<=0.01,]

Table_FLR_AllRice_pform_MM_R10 <- FLR_AllRice_pform_MM_R10 %>%
  dplyr::select(dataset, Rnumber) %>% 
  group_by(dataset) %>% 
  summarise(NumPform_Max = max(Rnumber))
...
AllRice_PSM$Peptidoform <- paste0(AllRice_PSM$Peptide_mod,"_",AllRice_PSM$PTM_positions)


Unadjusted_Rice_Max <- aggregate(PTM_final_prob ~ Peptidoform+dataset, data = AllRice_PSM, max)
...
Bin_PXD000923_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD000923, max)
Bin_PXD002222_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD002222, max)
Bin_PXD002756_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD002756, max)
Bin_PXD004705_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD004705, max)
Bin_PXD004939_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD004939, max)
Bin_PXD005241_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD005241, max)
Bin_PXD012764_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD012764, max)
Bin_PXD019291_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD019291, max)

Bin_PXD000923_Max$Peptide_mod <- Bin_PXD000923_Max$Peptide_mod.x
Bin_PXD002222_Max$Peptide_mod <- Bin_PXD002222_Max$Peptide_mod.x
Bin_PXD002756_Max$Peptide_mod <- Bin_PXD002756_Max$Peptide_mod.x
Bin_PXD004705_Max$Peptide_mod <- Bin_PXD004705_Max$Peptide_mod.x
Bin_PXD004939_Max$Peptide_mod <- Bin_PXD004939_Max$Peptide_mod.x
Bin_PXD005241_Max$Peptide_mod <- Bin_PXD005241_Max$Peptide_mod.x
Bin_PXD012764_Max$Peptide_mod <- Bin_PXD012764_Max$Peptide_mod.x
Bin_PXD019291_Max$Peptide_mod <- Bin_PXD019291_Max$Peptide_mod.x

Bin_PXD000923_Max$Bin_Adjusted_Score <- Bin_PXD000923_Max$NewScore3
Bin_PXD002222_Max$Bin_Adjusted_Score <- Bin_PXD002222_Max$NewScore3
Bin_PXD002756_Max$Bin_Adjusted_Score <- Bin_PXD002756_Max$NewScore3
Bin_PXD004705_Max$Bin_Adjusted_Score <- Bin_PXD004705_Max$NewScore3
Bin_PXD004939_Max$Bin_Adjusted_Score <- Bin_PXD004939_Max$NewScore3
Bin_PXD005241_Max$Bin_Adjusted_Score <- Bin_PXD005241_Max$NewScore3
Bin_PXD012764_Max$Bin_Adjusted_Score <- Bin_PXD012764_Max$NewScore3
Bin_PXD019291_Max$Bin_Adjusted_Score <- Bin_PXD019291_Max$NewScore3
...
FLR_Bin_AllRice_pform_Max_R10 <- FLR_Bin_AllRice_pform_Max[FLR_Bin_AllRice_pform_Max$FLR_Adj_Score<=0.1,]
FLR_Bin_AllRice_pform_Max_R5 <- FLR_Bin_AllRice_pform_Max[FLR_Bin_AllRice_pform_Max$FLR_Adj_Score<=0.05,]
FLR_Bin_AllRice_pform_Max_R1 <- FLR_Bin_AllRice_pform_Max[FLR_Bin_AllRice_pform_Max$FLR_Adj_Score<=0.01,]



Table_FLR_Bin_AllRice_pform_Max_R10 <- FLR_Bin_AllRice_pform_Max_R10 %>%
  dplyr::select(dataset, Rnumber) %>% 
  group_by(dataset) %>% 
...
Bin_PXD000923_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD000923_USI, max)
Bin_PXD002222_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD002222_USI, max)
Bin_PXD002756_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD002756_USI, max)
Bin_PXD004705_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD004705_USI, max)
Bin_PXD004939_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD004939_USI, max)
Bin_PXD005241_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD005241_USI, max)
Bin_PXD012764_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD012764_USI, max)
Bin_PXD019291_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod.x+PTM_positions, data = Bin_PXD019291_USI, max)

Bin_PXD000923_MM$Peptide_mod <- Bin_PXD000923_MM$Peptide_mod.x
Bin_PXD002222_MM$Peptide_mod <- Bin_PXD002222_MM$Peptide_mod.x
Bin_PXD002756_MM$Peptide_mod <- Bin_PXD002756_MM$Peptide_mod.x
Bin_PXD004705_MM$Peptide_mod <- Bin_PXD004705_MM$Peptide_mod.x
Bin_PXD004939_MM$Peptide_mod <- Bin_PXD004939_MM$Peptide_mod.x
Bin_PXD005241_MM$Peptide_mod <- Bin_PXD005241_MM$Peptide_mod.x
Bin_PXD012764_MM$Peptide_mod <- Bin_PXD012764_MM$Peptide_mod.x
Bin_PXD019291_MM$Peptide_mod <- Bin_PXD019291_MM$Peptide_mod.x

Bin_PXD000923_MM$Bin_Adjusted_Score <- Bin_PXD000923_MM$NewScore3
Bin_PXD002222_MM$Bin_Adjusted_Score <- Bin_PXD002222_MM$NewScore3
Bin_PXD002756_MM$Bin_Adjusted_Score <- Bin_PXD002756_MM$NewScore3
Bin_PXD004705_MM$Bin_Adjusted_Score <- Bin_PXD004705_MM$NewScore3
Bin_PXD004939_MM$Bin_Adjusted_Score <- Bin_PXD004939_MM$NewScore3
Bin_PXD005241_MM$Bin_Adjusted_Score <- Bin_PXD005241_MM$NewScore3
Bin_PXD012764_MM$Bin_Adjusted_Score <- Bin_PXD012764_MM$NewScore3
Bin_PXD019291_MM$Bin_Adjusted_Score <- Bin_PXD019291_MM$NewScore3
...
FLR_Bin_AllRice_pform_MM_R10 <- FLR_Bin_AllRice_pform_MM[FLR_Bin_AllRice_pform_MM$FLR_Adj_Score<=0.1,]
FLR_Bin_AllRice_pform_MM_R5 <- FLR_Bin_AllRice_pform_MM[FLR_Bin_AllRice_pform_MM$FLR_Adj_Score<=0.05,]
FLR_Bin_AllRice_pform_MM_R1 <- FLR_Bin_AllRice_pform_MM[FLR_Bin_AllRice_pform_MM$FLR_Adj_Score<=0.01,]

Table_FLR_Bin_AllRice_pform_MM_R10 <- FLR_Bin_AllRice_pform_MM_R10 %>%
  dplyr::select(dataset, Rnumber) %>% 
  group_by(dataset) %>% 
  summarise(NumPform_Max = max(Rnumber))
