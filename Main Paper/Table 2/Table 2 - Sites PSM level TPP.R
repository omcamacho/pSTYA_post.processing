...
Not_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod.x,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$Synthetic_full_match_False, BinAdj_Syn7058_PSM$PTM_final_prob)
names(Not_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions", "Incorrect.count" ,"Unadjusted_Score")

Bin_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod.x,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$Synthetic_full_match_False,BinAdj_Syn7058_PSM$NewScore3)
names(Bin_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM_positions", "Incorrect.count" ,"Bin_Adjusted_Score")

Prod_adj_Syn7058_PSM <- cbind.data.frame(ProdAdj_Syn7058_PSM$Peptide_mod.x,ProdAdj_Syn7058_PSM$Peptide,ProdAdj_Syn7058_PSM$PTM_positions,ProdAdj_Syn7058_PSM$Synthetic_full_match_False,ProdAdj_Syn7058_PSM$Prod_Adjusted_Score)
