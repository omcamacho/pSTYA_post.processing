...
#Prod_adj_Syn138_PSM <- cbind.data.frame(ProdAdj_Syn138_PSM$Peptide_mod,ProdAdj_Syn138_PSM$Peptide,ProdAdj_Syn138_PSM$PTM_positions,ProdAdj_Syn138_PSM$Prod_Adjusted_Score)
...
#Prod_adj_Syn7058_PSM <- cbind.data.frame(ProdAdj_Syn7058_PSM$Peptide_mod,ProdAdj_Syn7058_PSM$Peptide,ProdAdj_Syn7058_PSM$PTM_positions,ProdAdj_Syn7058_PSM$Prod_Adjusted_Score)
