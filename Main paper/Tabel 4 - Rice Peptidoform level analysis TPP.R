...
Bin_PXD000923_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD000923, max)
Bin_PXD002222_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD002222, max)
Bin_PXD002756_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD002756, max)
Bin_PXD004705_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD004705, max)
Bin_PXD004939_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD004939, max)
Bin_PXD005241_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD005241, max)
Bin_PXD012764_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD012764, max)
Bin_PXD019291_Max <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD019291, max)
...
Bin_PXD000923_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD000923_USI, max)
Bin_PXD002222_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD002222_USI, max)
Bin_PXD002756_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD002756_USI, max)
Bin_PXD004705_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD004705_USI, max)
Bin_PXD004939_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD004939_USI, max)
Bin_PXD005241_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD005241_USI, max)
Bin_PXD012764_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD012764_USI, max)
Bin_PXD019291_MM <- aggregate(NewScore3 ~ Peptidoform+dataset+Peptide+Peptide_mod+PTM_positions, data = Bin_PXD019291_USI, max)
