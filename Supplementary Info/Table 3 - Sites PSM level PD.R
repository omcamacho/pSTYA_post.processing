...
Not_adj_Syn138_PSM <- cbind.data.frame(BinAdj_Syn138_PSM$Peptide_mod,BinAdj_Syn138_PSM$Peptide,BinAdj_Syn138_PSM$PTM.positions,BinAdj_Syn138_PSM$Incorrect.count,BinAdj_Syn138_PSM$PTM_final_prob)
names(Not_adj_Syn138_PSM)<-c("Peptide_mod", "Peptide", "PTM.positions", "Incorrect.count" ,"Unadjusted_Score")

Bin_adj_Syn138_PSM <- cbind.data.frame(BinAdj_Syn138_PSM$Peptide_mod,BinAdj_Syn138_PSM$Peptide,BinAdj_Syn138_PSM$PTM.positions,BinAdj_Syn138_PSM$Incorrect.count,BinAdj_Syn138_PSM$Bin_Adjusted_Score)
names(Bin_adj_Syn138_PSM)<-c("Peptide_mod", "Peptide", "PTM.positions" ,"Incorrect.count" ,"Bin_Adjusted_Score")
...
Not_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$Synthetic_full_match, BinAdj_Syn7058_PSM$PTM_final_prob)
names(Not_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM.positions", "Incorrect.count" ,"Unadjusted_Score")

Bin_adj_Syn7058_PSM <- cbind.data.frame(BinAdj_Syn7058_PSM$Peptide_mod,BinAdj_Syn7058_PSM$Peptide,BinAdj_Syn7058_PSM$PTM_positions,BinAdj_Syn7058_PSM$Synthetic_full_match,BinAdj_Syn7058_PSM$Bin_Adjusted_Score)
names(Bin_adj_Syn7058_PSM)<-c("Peptide_mod", "Peptide", "PTM.positions", "Incorrect.count" ,"Bin_Adjusted_Score")
